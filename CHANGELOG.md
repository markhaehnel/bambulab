...
- *(deps)* bump serde_json from 1.0.148 to 1.0.149 ([#111](https://github.com/markhaehnel/bambulab/pull/111))
...
- *(deps)* bump paho-mqtt from 0.13.2 to 0.13.3 ([#88](https://github.com/markhaehnel/bambulab/pull/88))
...
- *(deps)* bump tokio from 1.44.0 to 1.44.1 ([#81](https://github.com/markhaehnel/bambulab/pull/81))
